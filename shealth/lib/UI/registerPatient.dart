          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Container(
                  margin:
                      EdgeInsets.symmetric(vertical: SizeConfig.safeBlockVertical * 15),
                  child: Center(
                    child: CustomButton(
                        text: 'Register',
                        onTap: () async {
                          await Provider.of<Auth>(context,listen: false).registerPatient(name, email, phNo, gender, age, password);
